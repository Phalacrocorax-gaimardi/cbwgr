#' Constrained configuration parameters for the FaIR Ensemble
#'
#' Parameters of the 3 timescale temperature-forcing response (Greens) functions used to create the FaIR ensemble. These are
#' found from calibration to CMIP6 Earth System Models as described in Cummins et al (2020). The constrained ensemble is defined here to give median 1.9C peak warming in SSP1-26.
#'
#' @format
